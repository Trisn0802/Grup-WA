...
<body>
	<nav class="navbar navbar-dark bg-success fixed-top">
	  <a class="navbar-brand bg-dark" href="index.php" style="color: #fff; border: 3px solid white; border-radius: 5px; padding: 5px;">
	    Kembali
	  </a>
      <a class="navbar-brand" href="#">Barudak Dibaduyut</a>
	</nav>

	<div class="container mb-3">
		<h2 align="center" style="margin: 80px 10px 10px 10px;">Komentar</h2><hr>
	...
	<div class="navbar bg-dark">
		<div style="color: #fff;">© <?php echo date('Y'); ?> Copyright:
		    <a href="https://smkn1palingganteng.blogspot.com/" style="color: yellow; font-weight: bold;"> TrisnaCode</a>
		</div>
	</div>
    ...
    <!-- Source Code Dibuat Oleh DJAZULI IT -->
</body>
</html>